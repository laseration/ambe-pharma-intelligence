...
const upsertQualificationBodySchema = z
  .object({
    qualificationStatus: qualificationStatusSchema.optional(),
    trustTier: trustTierSchema.optional(),
...
suppliersRouter.get(
  ...
  asyncHandler(async (request, response) => {
    const { query } = parseRequest<
      unknown,
      z.infer<typeof supplierScorecardsQuerySchema>
    >(request, {
...
suppliersRouter.get(
  ...
  asyncHandler(async (request, response) => {
    const { query } = parseRequest<
      unknown,
      z.infer<typeof supplierQualificationsQuerySchema>
    >(request, {
...
suppliersRouter.get(
  ...
  asyncHandler(async (request, response) => {
    ...
    response.json({
      item: requireFound(
        await supplierQualificationService.getQualificationForSupplier(
          params.id,
        ),
