...
function createEmailConfigError(): Error {
  return new Error(
    'Email alerts are not configured. Set EMAIL_ALERTS_ENABLED, MICROSOFT_GRAPH_TENANT_ID, MICROSOFT_GRAPH_CLIENT_ID, MICROSOFT_GRAPH_SENDER_MAILBOX, INTERNAL_ALERT_EMAIL_RECIPIENTS, and either MICROSOFT_GRAPH_CLIENT_SECRET or MICROSOFT_GRAPH_REFRESH_TOKEN.',
  );
}
